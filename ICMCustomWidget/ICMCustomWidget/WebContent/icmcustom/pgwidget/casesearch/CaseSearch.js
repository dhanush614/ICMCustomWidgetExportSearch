define(
    ["dojo/_base/declare",
        ...
        "gridx/modules/Sort", "dojo/aspect",
    ...
    function(declare, Button, lang, array, cells,
        BaseDialog, FilteringSelect,
        _CheckBoxSelector, DataGrid, cellsDijit, ItemFileWriteStore,
        dijit, date,
        ObjectStore, Memory, Row, Sort, aspect,
        CaseSearchContentPane, SearchPayload,
            ...
            [BasePageWidget, CaseSearchContentPane], {
                ...
                onExecute: function(model) {
                    ...
                    var initiateTaskDialog1 = new BaseDialog({
                        ...
                        getCaseTypePropData: lang.hitch(this,function() {
                                            ...
                                            .hitch(
                                                ...
                                                function(
                                                    ...
                                                    for (var i = 0; i < rows; i++) {
                                                        ...
                                                        if (i == (rows - 1)) {
                                                            initiateTaskDialog1.createGridTable();
                                                        }
                                                    }
                                                }));
                        ...
                        onExport: lang.hitch(this,function() {
                            var symNames = "";
                            var displayNames = [];
                            ...
                            this._searchQuery.search(lang.hitch(this, function(results) {
                                            if (results.items.length > 0) {
                                                if (results.items.length <= 1500) {
                                                    ...
                                                    var fileName = "SearchExportTemplate.xlsx";
                                                    ...
                                                    var TOS = this.widgetProperties.targetOS;
                                                    var repositoryObj = ecm.model.desktop.getRepositoryByName(TOS);
                                                    var folderPath = this.widgetProperties.folderPath;
                                                    initiateTaskDialog1.addDocument(folderPath, repositoryObj, fileObj);
                                                }
                                            } else {
                        ...
                        addDocument:lang.hitch(this,function(path, rep, file) {
                            rep.retrieveItem(path, lang.hitch(this, function(Folder) {
                                ...
                                var templateName = this.widgetProperties.docClass;
                                var criterias = [{
                                    "name": "DocumentTitle",
                                    "value": caseTypeValue,
                                    "dataType": "xs:string",
                    ...
                    initiateTaskDialog1.setTitle("Select columns to export");
